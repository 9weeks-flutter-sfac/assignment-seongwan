...
enum TodoFilter { all, completed, incompleted }  // enum은 class는 아니지만 미리 설정해놓는 상수값.
      ...
      child: Column(
        ...
        children: [
          ListTile(
            ...
            trailing: Checkbox(
              value: widget.filter == TodoFilter.all,  // 체크박스에 체크가 되고,
              onChanged: (value) {
                if (value == true) onApply(TodoFilter.all);  // 체크박스가 체크 되었을 때(true일 때), onApply 실행.
              },
            ),
          ),
          ListTile(
